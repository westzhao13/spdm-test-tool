...
int pcie_doe_register_irq(struct pcie_doe *doe, struct pci_dev *dev, int doe_offset);
int pcie_doe_exchange(struct pcie_doe *doe, u32 *request, size_t request_sz, u32 *response, size_t response_sz);
