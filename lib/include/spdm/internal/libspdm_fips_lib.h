 ...
 **/
void libspdm_fips_selftest_hmac_sha256(void *fips_selftest_context);
/**
 * HMAC-SHA384 KAT covers SHA384 KAT.
 **/
void libspdm_fips_selftest_hmac_sha384(void *fips_selftest_context);
/**
 * HMAC-SHA512 KAT covers SHA512 KAT.
 **/
void libspdm_fips_selftest_hmac_sha512(void *fips_selftest_context);
 ...
 * HKDF KAT test
 **/
void libspdm_fips_selftest_hkdf(void *fips_selftest_context);

/**
 * ECDH self_test
 **/
void libspdm_fips_selftest_ecdh(void *fips_selftest_context);
 ...
 * EDDSA self_test
 **/
void libspdm_fips_selftest_eddsa(void *fips_selftest_context);
 ...
 * ML-DSA self_test
 **/
void libspdm_fips_selftest_mldsa(void *fips_selftest_context);
